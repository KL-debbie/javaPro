	...
	$(function (){
		...
		$('.prev-btn').click(function (){
            if (currentPage > 1) {
				...
				location.replace("/jspPro/pulmuone_curation/curation02.jsp");
            }
		})
...
<div class="container curation">
	...
	<div class="button-set w220">
		<button class="prev-btn button-basic border" type="button">이전으로</button>
		<button class="next-btn button-basic primary" type="button">다음으로</button>
	</div>
</div>
