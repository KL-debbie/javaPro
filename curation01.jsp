...
/* 큐레이션 결과 */
.result-select-group label input+div {
...
$("#nextPage").on("click", function() {
	if($("input:checkbox:checked").is(":checked") == true){
		...
		$("#alertModal").hide();
		location.href= "/jspPro/pulmuone_curation/curation02.jsp"
	}else{
		$("#alertModal").show();
		return;
	}	
...
<form method="post" action="<%= path%>/pulmuone_curation/curation01.jsp"></form>
